        ...
        if input_ids is not None and (image_grid_thw is not None or video_grid_thw is not None):
            ...
            for i, input_ids in enumerate(total_input_ids):
                ...
                for _ in range(image_nums + video_nums):
                    ...
                    #self.config.vision_config.tokens_per_second = self.config.vision_config.tokens_per_second.to(self.device)
                    time_tensor = expanded_range * second_per_grid_t.to("cpu") * self.config.vision_config.tokens_per_second
